const verifyAccountLayout = (firstname) => {
    return `
    <!DOCTYPE html
                                ...
                                <tr>
                                    <td class="padding">
                                        <table align="center" class="details">
                                            <tr>
                                                <td>
                                                    <table align="center" class="content">
                                                        <tr>
                                                            <td>
                                                                <p style="font-size: 18px; font-weight: 500;">Confirmar Identidad</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <p class="mailbody">Hola, ${firstname}. Detectamos que alguien ha estado intentando
                                                                    acceder a tu cuenta, por lo que la hemos bloqueado temporalmente para proteger
                                                                    tu información.
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <p style="color: #000000;padding: 0 20px; margin-bottom: 40px;">Para revertir esta
                                                                acción, confirma tu identidad haciendo click en el siguiente enlace:</p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <a href="#" style="margin: 0 140px; padding: 20px 25px; outline: none; border: none; 
                                                                    ...
                                                                    text-decoration: none;">Confirmar identidad</a>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <p style="color: #000000; padding: 0 20px">Obtén más información sobre el bloqueo de tu cuenta, 
