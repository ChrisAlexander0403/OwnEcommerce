                                    ...
                                    <tr>
                                        <td class="padding">
                                            <table align="center" class="details">
                                                <tr>
                                                    <td>
                                                        <table align="center" class="content">
                                                            <tr>
                                                                <td>
                                                                    <p style="font-size: 18px; font-weight: 500;">Confirmar Cuenta</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                    <p class="mailbody">Hola, ${firstname}. Gracias por registrarte en Intecel.com, para finalizar tu registro
                                                ...
                                                <tr>
                                                    <td>
                                                        <p style="color: #000000; padding: 0 20px">Suscribete para recibir ofertas ocasionales, 
